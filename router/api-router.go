...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/user-agreement", middleware.DisableCache(), controller.GetUserAgreement)
		apiRouter.GET("/privacy-policy", middleware.DisableCache(), controller.GetPrivacyPolicy)
		apiRouter.GET("/about", middleware.DisableCache(), middleware.HeaderNavModuleAuth("about"), controller.GetAbout)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/model_ratio", controller.GetUserModelRatio)
				adminRoute.PUT("/:id/model_ratio", controller.UpdateUserModelRatio)

...
type TaskBillingContext struct {
	...
	VideoTierPricing                 *types.TaskVideoTierPricing `json:"video_tier_pricing,omitempty"`
	AllowPerCallCompletionAdjustment bool                        `json:"allow_per_call_completion_adjustment,omitempty"`
}

...
import (
	...
	"github.com/QuantumNous/new-api/relay/channel/baichuan"
		"github.com/QuantumNous/new-api/relay/channel/lingyiwanwu"
		"github.com/QuantumNous/new-api/relay/channel/minicpm"
		"github.com/QuantumNous/new-api/relay/channel/sensenova"
		"github.com/QuantumNous/new-api/relay/channel/skywork"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "NovaAPI")
		}
	}
	return nil
}
...
func (a *Adaptor) GetModelList() []string {
	...
	case constant.ChannelTypeSenseNova:
		return sensenova.ModelList
	case constant.ChannelTypeMiniCPM:
		return minicpm.ModelList
	case constant.ChannelTypeSkywork:
		return skywork.ModelList
...
func (a *Adaptor) GetChannelName() string {
	...
	case constant.ChannelTypeStepFun:
		return stepfun.ChannelName
	case constant.ChannelTypeBaichuan:
		return baichuan.ChannelName
	case constant.ChannelTypeSenseNova:
		return sensenova.ChannelName
	case constant.ChannelTypeMiniCPM:
		return minicpm.ChannelName
	case constant.ChannelTypeSkywork:
		return skywork.ChannelName

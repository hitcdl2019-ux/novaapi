				...
				for _, mediaMessage := range message.ParseContent() {
					...
					default:
						...
						if strings.HasPrefix(mimeType, "text/") {
							...
							if err != nil {
								return nil, fmt.Errorf("decode text file for Claude: %w", err)
							}
							claudeMediaMessage.Type = "text"
							claudeMediaMessage.Text = common.GetPointer(string(data))
							claudeMediaMessage.Source = nil
						...
						if claudeMediaMessage.Source != nil {
